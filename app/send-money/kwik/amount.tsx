...
export default function KwikTransferAmountScreen() {
  ...
  const continueToConfirm = () => {
    ...
    router.push({
      pathname: '/send-money/kwik/confirm',
      params: withOriginParams(from, kwikParamsToRoute({ ...params, amount: amountDigits })),
    });
  };
