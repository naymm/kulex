...
export default function BancoTransferAmountScreen() {
  ...
  const continueToConfirm = () => {
    ...
    router.push({
      pathname: '/send-money/banco/confirm',
      params: withOriginParams(from, bankParamsToRoute({ ...params, amount: amountDigits })),
    });
  };
