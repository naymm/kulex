...
import { getTransferAccounts, parseMyAccountsParams } from '@/lib/my-accounts';
import { formatMoneyFromDigitsAsCents } from '@/lib/money';
import {
  buildMyAccountsTransferReceipt,
} from '@/lib/transfer-receipt';

export default function MyAccountsTransferSuccessScreen() {
  ...
  const receipt = useMemo(
    () => buildMyAccountsTransferReceipt(params, generatedAt),
    [params, generatedAt],
  );
      ...
      <View style={styles.center}>
        ...
        <Animated.View style={contentStyle}>
          ...
          <Text style={styles.subtitle}>
            {amountFormatted} kz transferidos de {fromAccount.name} para {toAccount.name}
          </Text>
        </Animated.View>
      </View>
    </AddMoneyShell>
