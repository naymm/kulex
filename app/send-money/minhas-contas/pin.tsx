...
import { myAccountsParamsToRoute, parseMyAccountsParams } from '@/lib/my-accounts';

export default function MyAccountsTransferPinScreen() {
  ...
  const addDigit = (digit: string) => {
    ...
    if (next.length === 4) {
      setTimeout(() => {
        router.push({
          pathname: '/send-money/minhas-contas/success',
  ...
  return (
    <AddMoneyShell title="Minhas Contas">
