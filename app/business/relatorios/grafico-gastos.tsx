...
import { BUSINESS_SPENDING_SUMMARY } from '@/constants/spending-chart';
import { goBackFromOrigin } from '@/lib/navigation';

const NAVY = '#1A1A4E';

export default function BusinessGraficoGastosScreen() {
    ...
    <View style={styles.container}>
      ...
      <ScrollView
        ...
        <Text style={styles.intro}>
          Despesas da loja por categoria em {BUSINESS_SPENDING_SUMMARY.monthLabel.toLowerCase()}.
        </Text>
        <SpendingChart summary={BUSINESS_SPENDING_SUMMARY} />
      </ScrollView>
    </View>
  );
}
