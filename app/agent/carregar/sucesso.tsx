...
export default function AgentCarregarSucessoScreen() {
    ...
    <AddMoneyShell
      ...
      <View style={styles.center}>
        ...
        <Animated.View style={[styles.content, contentStyle]}>
          <Text style={styles.title}>Cash-in efectuado{'\n'}com sucesso</Text>

          <View style={styles.card}>
            <DetailRow label="Montante" value={`AOA ${amountFormatted}`} />
            <DetailRow label="Cliente" value={name} />
            <DetailRow label="Telefone" value={formatAgentPhone(clientPhone)} />
            <DetailRow label="Comissão" value="AOA 750,00" />
