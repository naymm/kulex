...
export default function CreditoSucesso() {
    ...
    <AddMoneyShell
      ...
      <View style={styles.center}>
        ...
        <Animated.View style={[styles.content, contentStyle]}>
          <Text style={styles.title}>Crédito solicitado com sucesso</Text>
          <Text style={styles.subtitle}>
            Em até 2 horas o valor será creditado na sua conta. Receberá uma
