...
import { JOGO_PROVIDERS, type JogoProvider } from '@/constants/jogos';
...
export default function JogosScreen() {
  ...
  const openProvider = (provider: JogoProvider) => {
    Alert.alert(
      provider.label,
      `Carregamento de conta ${provider.label} em breve na Kulex.`,
    );
  };
