...
import { TV_PROVIDERS, type TvProvider } from '@/constants/tv-streaming';
...
export default function TvStreamingScreen() {
  ...
  const openProvider = (provider: TvProvider) => {
    router.push({
      pathname: '/payments/tv/[provider]' as never,
    ...
    <View style={styles.container}>
      <View style={[styles.header, { paddingTop: insets.top + 12 }]}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.headerTitle}>Televisão e Streaming</Text>
        </View>
      </View>
