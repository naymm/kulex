...
export default function AutoInsuranceResumoScreen() {
  const insets = useSafeAreaInsets();
  const [acceptedTerms, setAcceptedTerms] = useState(false);
  const vehicle = DEFAULT_VEHICLE_FORM;
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView
        ...
        <InsuranceProgressStepper steps={AUTO_INSURANCE_STEPS} currentStep={3} />

        <View style={styles.card}>
          <Text style={styles.cardTitle}>Dados do Automóvel</Text>
          <SummaryGrid
            rows={[
              [
              ...
              [
                ...
                { label: 'Lugares', value: vehicle.lugares },
              ],
              [
                { label: 'Matrícula', value: vehicle.matricula },
                { label: 'Data da Matrícula', value: vehicle.dataPrimeiraMatricula },
              ],
              [
                { label: 'Peso', value: vehicle.peso },
                { label: 'Cor', value: vehicle.cor },
              ],
              [{ label: 'Data Início Seguro', value: vehicle.dataInicioSeguro, full: true }],
            ]}
          />
        </View>
        ...
        <View style={styles.card}>
          ...
          <SummaryGrid
            rows={[
              ...
              [
                { label: 'Data de Nascimento', value: '2001-04-04' },
      ...
      <View style={[styles.footer, { paddingBottom: Math.max(insets.bottom, 16) }]}>
        <Pressable
          ...
          onPress={() => router.push('/payments/seguros/automovel/pagamento')}
