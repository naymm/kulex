...
export default function AutoInsuranceTomadorScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView
        ...
        <InsuranceProgressStepper steps={AUTO_INSURANCE_STEPS} currentStep={2} />
      ...
      <View style={[styles.footer, { paddingBottom: Math.max(insets.bottom, 16) }]}>
        <Pressable
          ...
          onPress={() => router.push('/payments/seguros/automovel/resumo')}
