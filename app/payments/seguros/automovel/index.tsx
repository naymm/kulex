...
import { AUTO_INSURANCE_DETAIL } from '@/constants/automovel-insurance';

const NAVY = '#1A1A4E';

export default function AutoInsuranceDetailScreen() {
    ...
    <View style={styles.container}>
      <View style={[styles.header, { paddingTop: insets.top + 12 }]}>
        ...
        <View style={styles.heroRow}>
          ...
          <View>
            <Text style={styles.heroTitle}>{AUTO_INSURANCE_DETAIL.title}</Text>
            <Text style={styles.heroSubtitle}>{AUTO_INSURANCE_DETAIL.segment}</Text>
          </View>
        </View>
      </View>
      ...
      <ScrollView
        ...
        <InfoCard
          ...
          body={AUTO_INSURANCE_DETAIL.description}
        />
        <InfoCard
          icon="people-outline"
          title="A Quem Se Destina"
          body={AUTO_INSURANCE_DETAIL.audience}
        />
        ...
        <View style={styles.card}>
          ...
          {AUTO_INSURANCE_DETAIL.documents.map((doc, index) => (
            <Pressable
              key={doc.id}
              style={[styles.docRow, index === AUTO_INSURANCE_DETAIL.documents.length - 1 && styles.docRowLast]}
      ...
      <View style={[styles.footer, { paddingBottom: Math.max(insets.bottom, 16) }]}>
        <Pressable
          ...
          accessibilityRole="button"
          onPress={() => router.push('/payments/seguros/automovel/formulario')}>
