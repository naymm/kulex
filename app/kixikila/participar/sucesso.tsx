...
export default function ParticiparKixikilaSucessoScreen() {
      ...
      <View style={styles.center}>
        ...
        <Animated.View style={[styles.content, contentStyle]}>
          ...
          <Text style={styles.subtitle}>
            O seu pedido de participação a kixikila foi enviado com sucesso, aguarde que o
            organizador aprove o pedido.
          </Text>
        </Animated.View>
      </View>
    </AddMoneyShell>
