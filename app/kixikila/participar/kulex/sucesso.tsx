    ...
    <AddMoneyShell
      ...
      <View style={styles.center}>
        ...
        <Animated.View style={[styles.content, contentStyle]}>
          <Text style={styles.title}>Entraste na Kixikila com sucesso</Text>
          <Text style={styles.subtitle}>
            {title
              ? `Foste adicionado a ${title}. Os outros participantes aparecem de forma anónima até ao início do grupo.`
              : 'Foste adicionado ao grupo. Os outros participantes aparecem de forma anónima até ao início do grupo.'}
          </Text>
        </Animated.View>
      </View>
    </AddMoneyShell>
