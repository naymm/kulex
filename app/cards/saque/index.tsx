...
import { CARD_BALANCE } from '@/constants/card';
import { formatMoneyFromDigitsAsCents, normalizeDigits } from '@/lib/money';

export default function CardWithdrawAmountScreen() {
    ...
    <AddMoneyShell
      ...
      <View style={styles.amountSection}>
        ...
        <View style={styles.balancePill}>
          <Text style={styles.balanceText}>SALDO: AOA {CARD_BALANCE}</Text>
        </View>
      </View>
